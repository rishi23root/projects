...
import styles from '../../styles/eachPage/AddUser.module.css';
        ...
        <div className={styles.container}>
            <div className={styles.uploadcsv}>
                <Uploader 
                    ...
                    multiple={false}
                    draggable>
                    <div>Click or Drag CSV files to this area to upload and add Users</div>
                </Uploader>
            </div>
            {/* divider */}
            <Divider>Or</Divider>
            ...
            <form name="register" className={styles.formItself} onSubmit={handleSubmit}>
                <div className={styles.formGroup}>
                    ...
                    <button type="submit" className={styles.updateBtn}>Add user</button>
                </div>
                <div className={styles.inputAreaCointainer}>
                    ...
                    <div className={styles.inputCointainer}>
                        ...
                        <input required type="text" className={styles.inputItself} name='student_enrol_num' />
                    </div>
                    <div className={styles.inputCointainer}>
                        <div className={styles.lableforInput}>Admission no.</div>
                        <input required type="text" className={styles.inputItself} name='student_admi_num' />
                    </div>
                    <div className={styles.inputCointainer}>
                        <div className={styles.lableforInput}>Degree</div>
                        <input required type="text" className={styles.inputItself} name='student_deg' />
                    </div>
                    <div className={styles.inputCointainer}>
                        <div className={styles.lableforInput}>Branch</div>
                        <input required type="text" className={styles.inputItself} name='student_branch' />
                    </div>
                    <div className={styles.inputCointainer}>
                        <div className={styles.lableforInput}>Semester</div>
                        <input required type="number" className={styles.inputItself} name='student_sem' />
                    </div>
                </div>
            </form>
        </div>
